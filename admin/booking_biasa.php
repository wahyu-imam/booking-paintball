                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="../admin/tambah_booking_biasa.php" class="btn btn-icon-split btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM `booking`, jadwal, member WHERE booking.kode_jadwal=jadwal.kode_jadwal AND booking.kode_member=member.kode_member AND jenis_booking = 'biasa' AND tgl_booking >= '$tgl_sekarang'");
                                                $no = 1;
                                                    ...
                                                    <td><?php 
                                                        if ($tampil['konfirmasi'] == "Sudah") {
                                                           ...
                                                           <a href="#" class="btn btn-success float-center btn-sm">
                                                            ...
                                                            ?>
                                                            <a href="../admin/konfirmasi_booking_biasa_2.php?kode_booking=<?php echo $tampil['kode_booking'] ?>"><button class="btn btn-info btn-sm">Konfirmasi</button></a>
                                                            <?php 
                                                        }
                                                        ?>
                                                    </td>
...
<script type="text/javascript">
    $("#konfirmasi_biasa").click(function() {
        try {
            var kode_booking = document.getElementById('kode_booking_biasa').value;
