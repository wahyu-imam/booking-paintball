<?php
    ...
    $sql = mysqli_query($con, "SELECT MAX(kode_subPaket) AS kode FROM sub_paket");
    $data = mysqli_fetch_array($sql);
    $kode = $data['kode'];
    $urutan = (int) substr($kode, 3, 3);
    $urutan++;
    $huruf = "SP";
    $kodeDetailPaket = $huruf . sprintf("%03s", $urutan);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/tambah_detail_paket.php" class="breadcrumb-link">Tambah Detail Paket</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Tambah Data Detail Paket</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_detail_paket" class="col-form-label">Kode Detail Paket</label>
                                <input id="kode_detail_paket" name="kode_detail_paket" type="text" class="form-control" value="<?php echo $kodeDetailPaket ?>" readonly>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="kode_paket" name="kode_paket" type="text" class="form-control">
                                    ...
                                    ?>
                                        <option value="<?php echo $tampil['kode_paket']; ?>"><?php echo $tampil['nama_paket']; ?></option>
                                        <?php       
                                        }
                                        ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input id="sub_paket" name="sub_paket" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="ketentuan" class="col-form-label">Ketentuan</label>
                                <input id="ketentuan" name="ketentuan" type="text" class="form-control">
                            </div>
                            <div class="form-group">
...
<?php
    ...
    {
        $kode_detail_paket = $_POST['kode_detail_paket'];
        $kode_paket = $_POST['kode_paket'];
        $sub_paket = $_POST['sub_paket'];
        $ketentuan = $_POST['ketentuan'];
        $harga = $_POST['harga'];

        $simpan = mysqli_query($con, "INSERT INTO sub_paket(kode_subPaket, kode_paket, nama_sub, ketentuan, harga) values ('$kode_detail_paket','$kode_paket','$sub_paket','$ketentuan','$harga')");
