<?php
    ...
    $sql = mysqli_query($con, "SELECT MAX(kode_event) AS kode FROM event");
    $data = mysqli_fetch_array($sql);
    $kode = $data['kode'];
    $urutan = (int) substr($kode, 3, 3);
    $urutan++;
    $huruf = "E";
    $kode_event = $huruf . sprintf("%03s", $urutan);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/tambah_event.php" class="breadcrumb-link">Tambah Event</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Tambah Data Event</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_event" class="col-form-label">Kode Event</label>
                                <input id="kode_event" name="kode_event" type="text" class="form-control" value="<?php echo $kode_event ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama_event" class="col-form-label">Nama Event</label>
                                <input id="nama_event" name="nama_event" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="biaya_daftar" class="col-form-label">Biaya Pendaftaran</label>
                                <input id="biaya_daftar" name="biaya_daftar" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="tgl_buka" class="col-form-label">Tanggal Buka Pendaftaran</label>
                                <input type="text" class="form-control datetimepicker-input" id="tgl_buka" data-toggle="datetimepicker" data-target="#tgl_buka" data-date-format="DD/MM/YYYY" id="tgl_buka" name="tgl_buka" />
                            </div>
                            <div class="form-group">
                                <label for="tgl_tutup" class="col-form-label">Tanggal Tutup Pendaftaran</label>
                                <input type="text" class="form-control datetimepicker-input" id="tgl_tutup" data-toggle="datetimepicker" data-target="#tgl_tutup" data-date-format="DD/MM/YYYY" id="tgl_tutup" name="tgl_tutup" />
                            </div>
                            <div class="form-group">
                                <label for="tgl_mulai_main" class="col-form-label">Tanggal Mulai Bermain</label>
                                <input type="text" class="form-control datetimepicker-input" id="tgl_mulai_main" data-toggle="datetimepicker" data-target="#tgl_mulai_main" data-date-format="DD/MM/YYYY" id="tgl_mulai_main" name="tgl_mulai_main" />
                            </div>
                            <div class="form-group">
                                <label for="tgl_akhir_main" class="col-form-label">Tanggal Akhir Bermain</label>
                                <input type="text" class="form-control datetimepicker-input" id="tgl_akhir_main" data-toggle="datetimepicker" data-target="#tgl_akhir_main" data-date-format="DD/MM/YYYY" id="tgl_akhir_main" name="tgl_akhir_main" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="jam_akhir" name="jam_akhir" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="hadiah" name="hadiah" type="text" class="form-control">
                            </div>
                            <div>
...
<?php
    if(isset($_POST['simpan']))
    {
        ...
        $simpan = mysqli_query($con, "INSERT INTO event(kode_event, nama_event, biaya_daftar, tgl_buka, tgl_tutup, tgl_start_play, tgl_end_play, jam_play, jam_end, info, hadiah, status) VALUES ('$kode_event','$nama_event','$biaya_daftar','$tgl_buka','$tgl_tutup','$tgl_start_play','$tgl_end_play','$jam_play','$jam_end','$info','$hadiah','$status')");
