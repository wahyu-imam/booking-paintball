<?php
    ...
    $data_jadwal = mysqli_query($con, "SELECT * FROM jadwal WHERE kode_jadwal = '$kode_jadwal'");
    $tampil = mysqli_fetch_array($data_jadwal);
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/jadwal.php" class="breadcrumb-link">Jadwal</a></li>
                                        <li class="breadcrumb-item"><a href="../admin/ubah_jadwal.php" class="breadcrumb-link">Ubah Jadwal</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Ubah Data Jadwal</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_jadwal" class="col-form-label">Kode Jadwal</label>
                                <input id="kode_jadwal" name="kode_jadwal" type="text" class="form-control" value="<?php echo $tampil['kode_jadwal'] ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="jam" class="col-form-label">Jam</label>
                                <input id="jam" name="jam" type="text" class="form-control" value="<?php echo $tampil['jam'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="rentang" class="col-form-label">Rentang</label>
                                <input id="rentang" name="rentang" type="text" class="form-control" value="<?php echo $tampil['rentang'] ?>">
                            </div>
                            <div>
...
<?php
    if(isset($_POST['ubah']))
    {
        ...
        $simpan = mysqli_query($con, "UPDATE jadwal SET jam = '$jam', rentang = '$rentang' WHERE kode_jadwal = '$kode_jadwal'");
