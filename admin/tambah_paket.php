<?php
    ...
    $sql = mysqli_query($con, "SELECT MAX(kode_paket) as kode FROM paket");
    $data = mysqli_fetch_array($sql);
    $kode = $data['kode'];
    $urutan = (int) substr($kode, 3, 3);
    $urutan++;
    $huruf = "P";
    $kodePaket = $huruf . sprintf("%03s", $urutan);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                ...
                                <input id="kode_paket" name="kode_paket" type="text" class="form-control" value="<?php echo $kodePaket ?>" readonly>
                            </div>
                            <div class="form-group">
...
<?php
    if(isset($_POST['simpan']))
    {
        ...
        $simpan = mysqli_query($con, "INSERT INTO paket(kode_paket, nama_paket) VALUES ('$kode_paket','$nama_paket')");
