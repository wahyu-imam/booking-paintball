...
<script type="text/javascript">
    $("#btn_transaksi").click(function(){
            ...
            $.ajax({
                ...
                type: "post",
                data: {kode_booking : sendKodeBooking, kode_member : sendKodeMember, jenis_booking : sendJenisBooking, kode_detail_booking : sendKodeDetailBooking, kode_event : sendKodeEvent, total : sendTotal, bayar : sendBayar, kembali : sendKembali},
