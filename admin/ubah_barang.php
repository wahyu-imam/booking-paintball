<?php
    ...
    $data_barang = mysqli_query($con, "SELECT * FROM barang WHERE kode_barang = '$kode_barang'");
    $tampil = mysqli_fetch_array($data_barang);
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="../admin/barang.php"> Barang </a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/barang.php" class="breadcrumb-link">Barang</a></li>
                                        <li class="breadcrumb-item"><a href="../admin/ubah_barang.php" class="breadcrumb-link">Ubah Barang</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Ubah Data Barang</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_barang" class="col-form-label">Kode Barang</label>
                                <input id="kode_barang" name="kode_barang" type="text" class="form-control" value="<?php echo $tampil['kode_barang'] ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama_barang" class="col-form-label">Nama Barang</label>
                                <input id="nama_barang" name="nama_barang" type="text" class="form-control" value="<?php echo $tampil['nama_barang'] ?>">
                            </div>
                            <div>
...
<?php
    if(isset($_POST['ubah']))
    {
        ...
        $simpan = mysqli_query($con, "UPDATE barang SET nama_barang = '$nama_barang', stok = '$stok' WHERE kode_barang = '$kode_barang'");
