                    ...
                    <div class="card-body">
                        <form role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="bayar_event" name="bayar" type="number" class="form-control bayar">
                            </div>
                            <div class="form-group">
