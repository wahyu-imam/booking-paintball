<?php
    ...
    $dataPaket = mysqli_query($con, "SELECT * FROM sub_paket WHERE kode_subPaket = '$kode_detail_paket'");
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="../admin/detail_paket.php"> Detail Paket </a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/detail_paket.php" class="breadcrumb-link">Detail Paket</a></li>
                                        <li class="breadcrumb-item"><a href="../admin/ubah_detail_paket.php" class="breadcrumb-link">Ubah Detail Paket</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_detail_paket" class="col-form-label">Kode Detail Paket</label>
                                <input id="kode_detail_paket" name="kode_detail_paket" type="text" class="form-control" value="<?php echo $tampil['kode_subPaket']; ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="kode_paket" class="col-form-label">Nama Paket</label>
                                <select id="kode_paket" name="kode_paket" type="text" class="form-control">
                                    <?php 
                                        $sql = mysqli_query($con, 'SELECT * FROM `paket`');
                                        while ($tampil1 = mysqli_fetch_array($sql)) {
                                            if ($tampil['kode_paket'] == $tampil1['kode_paket']) {
                                                ?>
                                                <option value="<?php echo $tampil1['kode_paket']; ?>" selected><?php echo $tampil1['nama_paket']; ?></option>
                                            <?php 
                                            } else {
                                            ?>
                                        <option value="<?php echo $tampil1['kode_paket']; ?>"><?php echo $tampil1['nama_paket']; ?></option>
                                        <?php
                                            }       
                                        }
                                        ?>
                            ...
                            <div class="form-group">
                                <label for="sub_paket" class="col-form-label">Sub Paket</label>
                                <input id="sub_paket" name="sub_paket" type="text" class="form-control" value="<?php echo $tampil['nama_sub'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="ketentuan" class="col-form-label">Ketentuan</label>
                                <input id="ketentuan" name="ketentuan" type="text" class="form-control" value="<?php echo $tampil['ketentuan'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="harga" class="col-form-label">Harga / Orang</label>
                                <input id="harga" name="harga" type="text" class="form-control" value="<?php echo $tampil['harga'] ?>">
                            </div>
                            <div>
...
<?php
    if(isset($_POST['ubah']))
    {
        $kode_subPaket = $_POST['kode_detail_paket'];
        $kode_paket = $_POST['kode_paket'];
        $nama_sub = $_POST['sub_paket'];
        $ketentuan = $_POST['ketentuan'];
        $harga = $_POST['harga'];
        
        $simpan = mysqli_query($con, "UPDATE `sub_paket` SET `kode_paket`= '$kode_paket',`nama_sub`= '$nama_sub',`ketentuan`= '$ketentuan',`harga`= '$harga' WHERE `kode_subPaket`= '$kode_subPaket'");
