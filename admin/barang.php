                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="m-0 font-weight-bold text-gray-100 text-center">Daftar Data Barang</h3>
                            </div>
                            <div class="card-body">
                                <a href="../admin/tambah_barang.php" class="btn btn-icon-split btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM barang ORDER BY kode_barang ASC");
                                                $no = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- button ubah -->
                                                        <a href="../admin/ubah_barang.php?kode_barang=<?php echo $tampil['kode_barang'] ?>"><button class="btn btn-info btn-sm">Ubah</button></a>
                                                        <!-- button hapus -->
                                                        <a onclick="return confirm('Yakin Ingin Menghapus ?')" href="../admin/hapus_barang.php?kode_barang=<?php echo $tampil['kode_barang'] ?>"><button class="btn btn-danger btn-sm">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
