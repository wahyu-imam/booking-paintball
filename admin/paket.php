                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="m-0 font-weight-bold text-gray-100 text-center">Daftar Data Paket</h3>
                            </div>
                            <div class="card-body">
                                <a href="../admin/tambah_paket.php" class="btn btn-icon-split btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM paket ORDER BY kode_paket ASC");
                                                $no = 1;
                                                while ($tampil = mysqli_fetch_array($sql)) {
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $tampil['kode_paket']; ?></td>
                                                    <td><?php echo $tampil['nama_paket']; ?></td>       
                                                    <td>
                                                        <!-- button ubah -->
                                                        <a href="../admin/ubah_paket.php?kode_paket=<?php echo $tampil['kode_paket'] ?>"><button class="btn btn-info btn-sm">Ubah</button></a>
                                                        <!-- button hapus -->
                                                        <a onclick="return confirm('Yakin Ingin Menghapus ?')" href="../admin/hapus_paket.php?kode_paket=<?php echo $tampil['kode_paket'] ?>"><button class="btn btn-danger btn-sm">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
