                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/barang.php" class="breadcrumb-link">Jadwal</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="m-0 font-weight-bold text-gray-100 text-center">Daftar Data Jadwal</h3>
                            </div>
                            <div class="card-body">
                                <a href="../admin/tambah_jadwal.php" class="btn btn-icon-split btn-primary btn-sm">
                                    ...
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 15%">Kode Jadwal</th>
                                                <th>Jam</th>
                                                <th style="width: 15%">Rentang</th>
                                                <th style="width: 16%">Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM jadwal ORDER BY kode_jadwal ASC");
                                                $no = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- button ubah -->
                                                        <a href="../admin/ubah_jadwal.php?kode_jadwal=<?php echo $tampil['kode_jadwal'] ?>"><button class="btn btn-info btn-sm">Ubah</button></a>
                                                        <!-- button hapus -->
                                                        <a onclick="return confirm('Yakin Ingin Menghapus ?')" href="../admin/hapus_jadwal.php?kode_jadwal=<?php echo $tampil['kode_jadwal'] ?>"><button class="btn btn-danger btn-sm">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
