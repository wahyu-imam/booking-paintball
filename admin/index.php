...
<body>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="../login/aksi_logout.php"><i class="fas fa-power-off mr-2"></i>Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="../admin/index.php" data-toggle="" aria-expanded="false" data-target="" aria-controls=""><i class="fa fa-fw fa-user-circle"></i>Dashboard</span></a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="dataTableBiasa" class="table table-striped table-bordered first" style="width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM `booking`, jadwal, member WHERE booking.kode_jadwal=jadwal.kode_jadwal AND booking.kode_member=member.kode_member AND jenis_booking = 'biasa' AND konfirmasi = 'Belum'");
                                                $no = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $tampil['upload_file']; ?></td>
                                                    <td>
                                                        <!-- button ubah -->
                                                        <a href="../admin/konfirmasi_booking_biasa.php?kode_booking=<?php echo $tampil['kode_booking'] ?>"><button class="btn btn-info btn-sm">Konfirmasi</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM `detail_booking`, event, booking, member WHERE detail_booking.kode_event=event.kode_event AND booking.kode_booking=detail_booking.kode_booking AND booking.kode_member=member.kode_member AND konfirmasi = 'Belum'");
                                                $no = 1;
                                                while ($tampil = mysqli_fetch_array($sql)) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- button ubah -->
                                                        <a href="../admin/konfirmasi_booking_event.php?kode_booking=<?php echo $tampil['kode_booking'] ?>"><button class="btn btn-info btn-sm">Konfirmasi</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    <div id="modalKonfirmasiEvent" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>

    <div id="modalKonfirmasiBiasa" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
...
<script type="text/javascript">
    $("#konfirmasi_event").click(function(){
        var kode_booking = document.getElementById('kode_booking_event').value;

        var sendKodeBooking = JSON.stringify(kode_booking);

        $.ajax({
            url: "modal_konfirmasi_event.php",
            type: "post",
            data: {kode_booking : sendKodeBooking},
            success : function(data){
                $("#modalKonfirmasiEvent").html(data);
                $("#modalKonfirmasiEvent").modal('show');
            }
        });
    });
</script>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#dataTableBiasa').on('click', '.open_konfirmasi_biasa', function(e){
            var m = $(this).attr("id");
            $.ajax({
                url : "modal_konfirmasi_biasa.php",
                type : "GET",
                data : {kode_booking : m},
                success : function(data){
                    $("#modalKonfirmasiBiasa").html(data);
                    $("#modalKonfirmasiBiasa").modal('show');
                }
                error : function(){
                    alert("gagal");
                }
