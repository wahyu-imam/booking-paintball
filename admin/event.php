                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="m-0 font-weight-bold text-gray-100 text-center">Daftar Data Event</h3>
                            </div>
                            <div class="card-body">
                                <a href="../admin/tambah_event.php" class="btn btn-icon-split btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered first" style="width: 100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT kode_event, nama_event, biaya_daftar, concat(DATE_FORMAT(tgl_buka, '%d/%m/%Y'),' sampai ',DATE_FORMAT(tgl_tutup, '%d/%m/%Y')) AS tgl_daftar, concat(DATE_FORMAT(tgl_start_play, '%d/%m/%Y'),' sampai ',DATE_FORMAT(tgl_end_play, '%d/%m/%Y')) AS tgl_main, concat(jam_play,' sampai ',jam_end) AS jam_main, info, hadiah, status FROM event");
                                                $no = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $tampil['biaya_daftar']; ?></td>
                                                    <td><?php echo $tampil['tgl_daftar']; ?></td>
                                                    <td><?php echo $tampil['tgl_main']; ?></td>
                                                    <td><?php echo $tampil['jam_main']; ?></td>
                                                    <td><?php echo $tampil['info']; ?></td>
                                                    <td><?php echo $tampil['hadiah']; ?></td>
                                                    <td><?php echo $tampil['status']; ?></td>
                                                    <td>
                                                        <!-- button ubah -->
                                                        <a class="text-primary" href="../admin/ubah_event.php?kode_event=<?php echo $tampil['kode_event'] ?>">Ubah</a>
                                                        <!-- button hapus -->
                                                        <a class="mx-3 text-danger" onclick="return confirm('Yakin Ingin Menghapus ?')" href="../admin/hapus_event.php?kode_event=<?php echo $tampil['kode_event'] ?>">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
