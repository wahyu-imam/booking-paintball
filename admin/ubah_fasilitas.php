<?php
    ...
    $data_fasilitas = mysqli_query($con, "SELECT * FROM fasilitas WHERE kode_fasilitas = '$kode_fasilitas'");
    $tampil = mysqli_fetch_array($data_fasilitas);
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="../admin/fasilitas.php"> Fasilitas </a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/fasilitas.php" class="breadcrumb-link">Fasilitas</a></li>
                                        <li class="breadcrumb-item"><a href="../admin/ubah_fasilitas.php" class="breadcrumb-link">Ubah Fasilitas</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Ubah Data Fasilitas</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_fasilitas" class="col-form-label">Kode Fasilitas</label>
                                <input id="kode_fasilitas" name="kode_fasilitas" type="text" class="form-control" value="<?php echo $tampil['kode_fasilitas'] ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="kode_subPaket" class="col-form-label">Nama Paket</label>
                                <select id="kode_subPaket" name="kode_subPaket" type="text" class="form-control">
                                    <?php 
                                        $sql = mysqli_query($con, 'SELECT * FROM `paket`, sub_paket WHERE paket.kode_paket=sub_paket.kode_paket');
                                        while ($tampil1 = mysqli_fetch_array($sql)) {
                                            if ($tampil['kode_subPaket'] == $tampil1['kode_subPaket']) {
                                                ?>
                                                <option value="<?php echo $tampil1['kode_subPaket']; ?>" selected><?php echo $tampil1['nama_paket'].' '.$tampil1['nama_sub'].' '.$tampil1['ketentuan']; ?></option>
                                            <?php 
                                            } else {
                                            ?>
                                        <option value="<?php echo $tampil1['kode_subPaket']; ?>"><?php echo $tampil1['nama_paket'].' '.$tampil1['nama_sub'].' '.$tampil1['ketentuan']; ?></option>
                                        <?php
                                            }       
                                        }
                                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <select id="kode_barang" name="kode_barang" type="text" class="form-control">
                                    <?php 
                                        $sql = mysqli_query($con, 'SELECT * FROM barang');
                                        while ($tampil1 = mysqli_fetch_array($sql)) {
                                            if ($tampil['kode_barang'] == $tampil1['kode_barang']) {
                                                ?>
                                                <option value="<?php echo $tampil1['kode_barang']; ?>" selected><?php echo $tampil1['nama_barang']; ?></option>
                                            <?php 
                                            } else {
                                            ?>
                                        <option value="<?php echo $tampil1['kode_barang']; ?>"><?php echo $tampil1['nama_barang']; ?></option>
                                        <?php
                                            }       
                                        }
                                        ?>
...
<?php
    if(isset($_POST['ubah']))
    {
        ...
        $kode_subPaket = $_POST['kode_subPaket'];
        $kode_barang = $_POST['kode_barang'];
        
        $simpan = mysqli_query($con, "UPDATE fasilitas SET kode_subPaket = '$kode_subPaket', kode_barang = '$kode_barang' WHERE kode_fasilitas = '$kode_fasilitas'");
