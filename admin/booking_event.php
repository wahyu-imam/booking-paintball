                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/booking_event.php" class="breadcrumb-link">Booking Event</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="../admin/tambah_booking_event.php" class="btn btn-icon-split btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM `detail_booking`, event, booking, member WHERE detail_booking.kode_event=event.kode_event AND booking.kode_booking=detail_booking.kode_booking AND booking.kode_member=member.kode_member AND status = 'Buka'");
                                                $no = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php 
                                                        if ($tampil['konfirmasi'] == "Sudah") {
                                                            ?>
                                                           <a href="#" class="btn btn-success float-center btn-sm">
                                                                <span class="text">Success</span>
                                                            </a>
                                                            <?php
                                                        }else{
                                                            ?>
                                                            <a href="../admin/konfirmasi_booking_event_2.php?kode_booking=<?php echo $tampil['kode_booking'] ?>"><button class="btn btn-info btn-sm">Konfirmasi</button></a>
                                                            <?php 
                                                        }
                                                        ?>
                                                    </td>
