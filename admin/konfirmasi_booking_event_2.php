                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/booking_biasa.php" class="breadcrumb-link">Booking Event</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <form role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="bayar" name="bayar" type="number" class="form-control bayar">
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $('#bayar').on('keyup', function(){
        var total = parseInt (document.getElementById('biaya').value);
        ...
        if($simpan_booking)
        {
            ?>
                <script type="text/javascript">
                    ...
                    window.location = "../admin/booking_event.php";
                </script>
            <?php
        }
    }
