<?php
    ...
    $sql = mysqli_query($con, "SELECT MAX(kode_jadwal) AS kode FROM jadwal");
    $data = mysqli_fetch_array($sql);
    $kode = $data['kode'];
    $urutan = (int) substr($kode, 1, 3);
    $urutan++;
    $huruf = "J";
    $kode_jadwal = $huruf . sprintf("%03s", $urutan);
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/tambah_jadwal.php" class="breadcrumb-link">Tambah Jadwal</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Tambah Data Jadwal</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_jadwal" class="col-form-label">Kode Jadwal</label>
                                <input id="kode_jadwal" name="kode_jadwal" type="text" class="form-control" value="<?php echo $kode_jadwal ?>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="rentang" name="rentang" type="text" class="form-control">
                            </div>
                            <div>
...
<?php
    if(isset($_POST['simpan']))
    {
        ...
        $simpan = mysqli_query($con, "INSERT INTO `jadwal`(`kode_jadwal`, `jam`, `rentang`) VALUES ('$kode_jadwal','$jam','$rentang')");
