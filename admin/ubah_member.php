<?php
    ...
    $data_member = mysqli_query($con, "SELECT * FROM member WHERE kode_member = '$kode_member'");
    $tampil = mysqli_fetch_array($data_member);
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/ubah_member.php" class="breadcrumb-link">Ubah Member</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Ubah Data Member</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_member" class="col-form-label">Kode Member</label>
                                <input id="kode_member" name="kode_member" type="text" class="form-control" value="<?php echo $tampil['kode_member'] ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nama_member" class="col-form-label">Nama Member</label>
                                <input id="nama_member" name="nama_member" type="text" class="form-control" value="<?php echo $tampil['nama_member'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="email" class="col-form-label">Email</label>
                                <input id="email" name="email" type="email" class="form-control" value="<?php echo $tampil['email'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="username" class="col-form-label">Username</label>
                                <input id="username" name="username" type="text" class="form-control" value="<?php echo $tampil['username'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="pass_awal" class="col-form-label">Password</label>
                                <input id="pass_awal" name="pass_awal" type="password" class="form-control" value="<?php echo $tampil['pass_awal'] ?>">
                            </div>
                            <div>
...
<?php
    if(isset($_POST['ubah']))
    {
        ...
        $simpan = mysqli_query($con, "UPDATE `member` SET `nama_member`='$nama_member',`email`='$email',`username`='$username',`pass`='$pass',`pass_awal`='$pass_awal' WHERE kode_member='$kode_member'");
