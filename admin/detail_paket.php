                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="m-0 font-weight-bold text-gray-100 text-center">Daftar Data Detail Paket</h3>
                            </div>
                            <div class="card-body">
                                <a href="../admin/tambah_detail_paket.php" class="btn btn-icon-split btn-primary btn-sm">
                                    ...
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 20%">Sub Paket</th>
                                                <th>Ketentuan</th>
                                                <th>Harga</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                while ($tampil = mysqli_fetch_array($sql)) {
                                                    $kode_paket = $tampil['kode_paket'];
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo $tampil['nama_paket']; ?></td>
                                                    <td><?php 
                                                            $sqlSub = mysqli_query($con, "SELECT * FROM sub_paket WHERE kode_paket = '$kode_paket'");
                                                            while ($tampilSub = mysqli_fetch_array($sqlSub)) {
                                                                 echo $tampilSub['nama_sub'].'<br>';
                                                             } 
                                                        ?>
                                                    </td>
                                                    <td><?php 
                                                    ...
                                                    <td class="text-center"><?php 
                                                            ...
                                                            while ($tampilSub = mysqli_fetch_array($sqlSub)) {
                                                                ?>
                                                                <a class="float-center text-primary" href="../admin/ubah_detail_paket.php?kode_detail_paket=<?php echo $tampilSub['kode_subPaket']; ?>">Ubah</a>

                                                                <a class="mx-3 text-danger float-center" onclick="return confirm('Yakin Ingin Menghapus ?')" href="../admin/hapus_detail_paket.php?kode_detail_paket=<?php echo $tampilSub['kode_subPaket']; ?>">Hapus</a><br>
                                                        <?php
                                                            } 
                                                        ?>
                                                    </td>
