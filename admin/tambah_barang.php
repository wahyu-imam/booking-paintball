<?php
    ...
    $sql = mysqli_query($con, "SELECT MAX(kode_barang) AS kode FROM barang");
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../admin/tambah_barang.php" class="breadcrumb-link">Tambah Barang</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Tambah Data Barang</h3>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST">
                            <div class="form-group">
                                <label for="kode_barang" class="col-form-label">Kode Barang</label>
                                <input id="kode_barang" name="kode_barang" type="text" class="form-control" value="<?php echo $kode_barang ?>" readonly>
                            </div>
                            <div class="form-group">
...
<?php
    if(isset($_POST['simpan']))
    {
        ...
        $simpan = mysqli_query($con, "INSERT INTO barang(kode_barang, nama_barang, stok) VALUES ('$kode_barang','$nama_barang','$stok')");
