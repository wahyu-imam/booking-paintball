                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-2-1" class="collapse submenu">
                                                <ul class="nav flex-column">
                                                    <li>
                                                        <a class="nav-link active" href="../member/lap_booking_biasa.php"> Biasa </a>
                                                    </li>
                                                    <li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM `booking`, jadwal, member WHERE booking.kode_jadwal=jadwal.kode_jadwal AND booking.kode_member=member.kode_member AND booking.kode_member = '$kode_member'");
                                                $no = 1;
