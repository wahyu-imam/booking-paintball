                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="../member/tambah_booking_biasa.php" class="btn btn-icon-split btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered first" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                $sql = mysqli_query($con, "SELECT * FROM booking, jadwal WHERE booking.kode_jadwal=jadwal.kode_jadwal AND kode_member='$kode_member' AND tgl_booking >= '$tgl_sekarang'");
                                                $no = 1;
                                                while ($tampil = mysqli_fetch_array($sql)) {
                                                    $konf = $tampil['konfirmasi'];
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    ...
                                                    <td><?php 
                                                        if (empty($tampil['upload_file'])) {
                                                            ?>
                                                            <a href="../member/upload_tf_booking_biasa.php?kode_booking=<?php echo $tampil['kode_booking'] ?>"><button class="btn btn-warning btn-sm">Kirim</button></a>
                                                            <?php
                                                        }else{
                                                            if ($konf == 'Sudah') {
                                                                ?>
