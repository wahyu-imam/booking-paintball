<?php
    ...
    $sqlPengguna = mysqli_query($con, "SELECT * FROM member WHERE username = '$pengguna'");
    $tampil_pengguna = mysqli_fetch_array($sqlPengguna);
    $kode_member = $tampil_pengguna['kode_member'];
    $nama_member = $tampil_pengguna['nama_member'];
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../member/tambah_booking_biasa.php" class="breadcrumb-link">Tambah Booking Biasa</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control datetimepicker-input" id="tgl_booking" data-toggle="datetimepicker" data-target="#tgl_booking" data-date-format="DD-MM-YYYY" name="tgl_booking" onchange="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
