<?php 
    ...
    $simpan_booking = mysqli_query($con, "INSERT INTO `booking`(`kode_booking`, `jenis_booking`, `tgl_booking`, `kode_jadwal`, `kode_member`, `biaya`, konfirmasi) VALUES ('$kode_booking','$jenis_booking','$tgl_booking','$kode_jadwal','$kode_member','$total','Belum')");
