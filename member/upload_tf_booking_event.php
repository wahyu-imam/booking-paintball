<?php
    ...
    $sql = mysqli_query($con, "SELECT * FROM `detail_booking`, event, booking, member WHERE detail_booking.kode_event=event.kode_event AND booking.kode_booking=detail_booking.kode_booking AND booking.kode_member=member.kode_member AND booking.kode_booking = '$kode_booking'");
    $tampil = mysqli_fetch_array($sql);
    $nama_member = $tampil['nama_member'];
    $nama_event = $tampil['nama_event'];
    $biaya = $tampil['biaya'];
    $bayar = $tampil['bayar'];
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-1" class="collapse submenu">
                                                <ul class="nav flex-column">
                                                    <li>
                                                        <a class="nav-link active" href="../member/booking_biasa.php"> Biasa </a>
                                                    </li>
                                                    <li>
            ...
            <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="../member/booking_biasa.php" class="breadcrumb-link">Booking Biasa</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-0 font-weight-bold text-gray-100 text-center">Detail Booking</h3>
                    </div>
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_event" name="nama_event" type="text" class="form-control" value="<?php  echo $nama_event ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="biaya" class="col-form-label">Total Pembayaran</label>
                                <input id="biaya" name="biaya" type="text" class="form-control" value="<?php  echo $biaya ?>" readonly>
                            </div>
                            <form action="?" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="submit" name="upload" class="btn btn-success float-left btn-sm" value="Kirim" />
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php 
    if (isset($_POST['upload'])) {
        ...
        $sql = "UPDATE booking SET upload_file = '$file_name' WHERE kode_booking = '$kode_booking'";
        ...
        if($simpan)
        {
            ?>
                <script type="text/javascript">
                    ...
                    window.location = "../member/booking_event.php";
                </script>
            <?php
        }
    }
