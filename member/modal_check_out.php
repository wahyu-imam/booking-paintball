...
<script type="text/javascript">
    $("#btn_transaksi").click(function(){
        ...
        $.ajax({
            ...
            type: "post",
            data: {kode_booking : sendKodeBooking, kode_member : sendKodeMember, tgl_booking : sendTglBooking, kode_jadwal : sendKodeJadwal, jenis_booking : sendJenisBooking, kode_detail_booking : sendKodeDetailBooking, kode_subPaket : sendKodeSubPaket, total : sendTotal},
